...
function getDates($FechaIni, $FechaFin) {
    ...
    $sql = "SELECT * FROM  `vw_rpt_marcacion` WHERE Fecharegistro BETWEEN '$FechaIni' AND DATE_ADD('$FechaFin', INTERVAL 1 DAY) ORDER BY Fecharegistro DESC ";
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title>EDATEL | Reporte de Visitas</title>
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-heading"> 
                                    <div class="page-header">
                                        <form method="post" class="form-horizontal" action="rpte_marcacion.php">
                                                        ...
                                                        if ($result) {
                                                            ...
                                                            while ($row = mysqli_fetch_array($result)) {
                                                                echo '<tr>
                                                                  ...
                                                                  <td>' . strtoupper(($row['Fecharegistro'])) . '</td>
