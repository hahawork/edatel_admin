...
function getDates($FechaIni, $FechaFin) {
    ...
    $sql = "SELECT * FROM `vw_rpt_ventashechas` WHERE FechaVenta BETWEEN '$FechaIni' AND DATE_ADD('$FechaFin', INTERVAL 1 DAY) ORDER BY FechaVenta DESC ";
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title>EDATEL | Reporte de Ventas</title>
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-heading"> 
                                    <div class="page-header">
                                        <form method="post" class="form-horizontal" action="rpte_ventas.php">
